...
private:
	...
	uint32_t                                 m_last_non_eop_debug_op        = UINT32_MAX;
	uint64_t                                 m_last_non_eop_debug_submit_id = 0;
	uint32_t                                 m_last_non_eop_debug_arg0      = 0;
	uint32_t                                 m_last_non_eop_debug_arg1      = 0;
	uint32_t                                 m_last_non_eop_debug_arg2      = 0;
